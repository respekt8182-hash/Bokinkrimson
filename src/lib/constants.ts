...
export const placementPricingGroupInfo = {
  MULTI_ROOM: {
    ...
    details:
      "До 20 июня размещение бесплатно. После бесплатного периода: 1–6 номеров — 4 990 ₽, 7–16 — 7 490 ₽, 17–25 — 9 990 ₽, 26+ — 13 990 ₽.",
  },
  SINGLE_UNIT: {
    title: "Отдельный объект",
    summary: "Одна квартира, один дом, один коттедж или одна комната.",
    details:
      "До 20 июня размещение бесплатно. После бесплатного периода фиксированная стоимость — 3 990 ₽.",
  },
} as const;
