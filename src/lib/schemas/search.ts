...
export const SearchFiltersSchema = z.object({
  ...
  nearSea: booleanParamSchema,
  hasPool: booleanParamSchema,
  hasKitchen: booleanParamSchema,
  hasAirConditioner: booleanParamSchema,
  hasParking: booleanParamSchema,
  smokingForbidden: booleanParamSchema,
  quietHours: booleanParamSchema,
  amenityIds: z.string().trim().max(500).optional(),
  "amenityIds[]": z.string().trim().max(500).optional(),
  roomFeatureIds: z.string().trim().max(500).optional(),
  "roomFeatureIds[]": z.string().trim().max(500).optional(),
