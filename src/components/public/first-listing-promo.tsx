  ...
  const content =
    kind === "housing"
      ? {
          ...
          description:
            "Добавьте жильё в каталог Крым Вокруг бесплатно до 20 июня и получите скидку 20% на дальнейшее продление.",
        }
      : kind === "transfers"
        ? {
            title: "Станьте первым, кто разместит трансфер",
            description:
              "Добавьте трансфер в каталог Крым Вокруг бесплатно до 20 июня и получите скидку 20% на дальнейшее продление.",
          }
        : {
            title: "Станьте первым, кто разместит экскурсию или тур",
            description:
              "Добавьте программу в каталог Крым Вокруг бесплатно до 20 июня и получите скидку 20% на дальнейшее продление.",
          };
