  ...
  const content =
    kind === "housing"
      ? {
          ...
          description:
            "Добавьте жильё в каталог Крым Вокруг бесплатно на 1 год и получайте обращения напрямую.",
        }
      : kind === "transfers"
        ? {
            title: "Станьте первым, кто разместит трансфер",
            description: "Добавьте трансфер в каталог Крым Вокруг и получайте обращения напрямую.",
          }
        : kind === "attractions"
          ? {
          ...
          : {
              ...
              description:
                "Добавьте программу в каталог Крым Вокруг бесплатно на 1 год и получайте обращения напрямую.",
            };
