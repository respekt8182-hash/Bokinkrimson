...
export const metadata: Metadata = {
  title: {
    absolute: "Жильё, экскурсии, места и трансферы по Крыму — Крым Вокруг",
  },
  description:
    "Крым Вокруг — маркетплейс жилья у моря, экскурсий, достопримечательностей и трансферов по Крыму. Сервис берет оплату только за размещение объявления на платформе: без комиссии с каждого клиента или бронирования.",
  alternates: {
    canonical: buildCanonicalPath("/"),
  },
  openGraph: {
    type: "website",
    title: "Жильё, экскурсии, места и трансферы по Крыму — Крым Вокруг",
    description:
      "Маркетплейс жилья, экскурсий, достопримечательностей и трансферов по Крыму без комиссии с каждого клиента или бронирования.",
    url: "/",
    locale: "ru_RU",
  },
  twitter: {
