...
export const metadata: Metadata = {
  ...
  description:
    "Крым Вокруг — маркетплейс жилья у моря, экскурсий, досуга и трансферов по Крыму. Сервис берет оплату только за размещение объявления на платформе: без комиссии с каждого клиента или бронирования.",
  alternates: {
