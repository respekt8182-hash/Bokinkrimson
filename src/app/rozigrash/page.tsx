...
export const metadata: Metadata = {
  ...
  description:
    "Условия розыгрыша сертификата на бесплатное размещение на сайте Крым Вокруг сроком на 365 дней: подпишитесь на ВК, сделайте репост и дождитесь итогов 9 мая.",
  alternates: {
