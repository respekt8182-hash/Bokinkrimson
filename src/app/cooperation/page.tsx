...
export const metadata: Metadata = {
  ...
  description:
    "Размещение жилья, экскурсий, туров и трансферов на Крым Вокруг бесплатно до 1 мая 2027, без комиссии с каждого клиента или бронирования.",
  alternates: {
...
const cooperationFacts = [
  ...
  "До 1 мая 2027 размещение бесплатно; карточки переходят в режим раннего доступа до конца бесплатного периода.",
...
const cooperationSteps = [
  ...
  "До 1 мая 2027 карточка отправляется на модерацию без оплаты и получает режим раннего доступа.",
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-3xl bg-cream/72 p-5 ring-1 ring-olive/10">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-7 text-olive/75">
              <li>
                До 1 мая 2027 размещение карточки бесплатно; после бесплатного периода сервис не
                удерживает процент с каждой заявки или бронирования.
              </li>
              <li>
