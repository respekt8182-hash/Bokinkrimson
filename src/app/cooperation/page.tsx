...
export const metadata: Metadata = {
  ...
  description:
    "Первое размещение жилья, экскурсий и туров на Крым Вокруг бесплатно на 1 год с даты публикации после модерации, без комиссии с каждого клиента или бронирования.",
  alternates: {
...
const cooperationFacts = [
  ...
  "Первый год размещение бесплатно; карточки переходят в режим раннего доступа до конца бесплатного периода.",
...
const cooperationSteps = [
  ...
  "Карточка отправляется на модерацию без оплаты и получает бесплатный год размещения.",
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-3xl bg-cream/72 p-5 ring-1 ring-olive/10">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-7 text-olive/75">
              <li>
                Первый год размещение карточки бесплатно; после бесплатного периода сервис не
