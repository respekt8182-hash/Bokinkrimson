...
export const metadata: Metadata = {
  ...
  description:
    "Первое размещение жилья, экскурсий и туров на Крым Вокруг бесплатно на 1 год с даты создания объявления, без комиссии с каждого клиента или бронирования.",
  alternates: {
