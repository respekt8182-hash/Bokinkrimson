...
const partnerBenefits = [
  ...
  },
  {
    ...
    text: `Сейчас первое размещение бесплатно на 1 год с даты публикации после модерации. После окончания бесплатного периода карточка остаётся на сайте, а в профиле появится отметка о необходимости оплаты.`,
  },
];
