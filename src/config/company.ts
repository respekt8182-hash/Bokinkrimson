...
export const companyConfig = {
  ...
  shortDescription:
    "Крым Вокруг — маркетплейс жилья у моря и экскурсий по Крыму. Идёт набор в ранний доступ: первое размещение на сайте бесплатно на 1 год с даты создания объявления; после бесплатного периода сервис не удерживает комиссию с каждого клиента или бронирования.",
